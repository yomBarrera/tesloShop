...
const AddressPage = () => {
  ...
  return (
    <ShopLayout title={'Direcciòn'} pageaDescription={'Confirmar direccion de destino'}>
      <form onSubmit={handleSubmit(onSubmitAddress)}>
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} sm={6}>
            <TextField label='Dirección2 (opcional)' variant='filled' fullWidth {...register('address2')} />
          </Grid>
